...
- Output: short text that describes the action or destination (where the link goes, what happens when activated)—not the stock photo or illustration subject.
- If `<image-block-usage>` or additional context gives a URL or destination name, base the alt on that purpose. Do not substitute a visual description of the image.
...
- Use any `<image-block-usage>` section and `<additional-context>` to decide role and wording; they override guessing from pixels alone.
